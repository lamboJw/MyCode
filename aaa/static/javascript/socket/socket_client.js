(function () {
	...
	w.CHAT = {
		...
		updateSysMsg:function(o, action){
			...
			//用户当前房间
			//this.room = o.room;
			//console.log(new Date().toLocaleString() + " ------>  " +this.room);
			//更新在线人数
			var userhtml = '';
		...
		init:function(username){
			...
			*/
			...
			//告诉服务器端有用户登录
			this.socket.emit('login', {userid:this.userid, username:this.username ,room:this.room,room_name:this.room_name});
